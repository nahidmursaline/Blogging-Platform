...
const MyBlog = () => {
  ...
  const url = `https://blogging-platform-server.vercel.app/blog?email=${user?.email}`;
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold pt-20 text-center pb-14">
        All My Blogs
      </h2>
      {!myBlogs && <p>Loading your blogs...</p>}
      {myBlogs?.length === 0 && (
        <p className="flex justify-center text-red-500 font-bold">
          You didn't add any blog. Add a blog first then you will see your blogs
          here.
        </p>
      )}
      {myBlogs && (
